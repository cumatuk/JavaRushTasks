    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                Double stock1Balance;
                Double stock2Balance;

                if (stock1.containsKey("change"))
                    stock1Balance = (Double) stock1.get("change");
                else stock1Balance = (Double) stock1.get("last") - (Double) stock1.get("open");
                if (stock2.containsKey("change"))
                    stock2Balance = (Double) stock2.get("change");
                else stock2Balance = (Double) stock2.get("last") - (Double) stock2.get("open");

                if (stock1Name.compareTo(stock2Name) != 0) return stock1Name.compareTo(stock2Name);
                else {
                    if (stock1Date.compareTo(stock2Date) != 0) return stock2Date.compareTo(stock1Date);
                    else return Double.compare(stock2Balance, stock1Balance);
                }
            }
        });
    }
